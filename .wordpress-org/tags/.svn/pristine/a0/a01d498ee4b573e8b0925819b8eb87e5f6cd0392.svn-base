...
* Parent pages used to organize URLs or menus, not present content
* Incomplete page sections assembled by plugins into more complete pages
...
= Does SearchCloak work multisite? =
